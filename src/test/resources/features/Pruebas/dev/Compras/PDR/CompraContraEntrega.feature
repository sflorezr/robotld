...
# Compra generada con la ruta feliz con usuarios nuevos y existentes , selecciona productos desde la PDR menores a $250.000 , los productos no deben superar este tope
